...
<h2 align="center">CHANAKYA'S GALLERY</h2>

<h4><span> the browser window to see the effect.</span></h4>
<?php
...
<div class="responsive">
    <div class="gallery">
      <a target="_blank" href="C:\Users\gkuma\OneDrive\Desktop\chanakya\images\01.jpg">
        <img src="admin/uploads/<?php echo $result['img']; ?> "alt="Forest" width="900" height="900">
        
      </a>
      <div class="desc"><?php echo $result['title']; ?></div>
    </div>
  </div>
<?php } ?>
