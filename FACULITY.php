...
<body>
  ...
  <table width="95%" border="1" cellpadding="4" cellspacing="4">
    <tr>
      <td width="6%">S.No.</td>
      <td width="40%">Name of the Faculty</td>
      <td width="24%">Qualification</td>
      <td width="16%">Subject</td>
      <td width="14%">Experience</td>
    </tr>
<?php
$sql=mysqli_query($con, "select * from faculty order by experience Asc ");
$i=1;
...
?>
    ...
    <tr>
      ...
      <td><?php echo $result['experience']; ?> Yrs</td>
    </tr>
    <?php
$i++;
} 
...
<footer>
    ...
    <div class="left-col">
      ...
      <a href="https://twitter.com/cdcjammikunta"><i class='fab fa-twitter' style='font-size:24px;color:blue'></i></a>
